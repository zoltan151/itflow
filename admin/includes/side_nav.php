...
<aside class="main-sidebar sidebar-dark-<?php echo nullable_htmlentities($config_theme); ?> d-print-none">
    ...
    <div class="sidebar">
        ...
        <li class="nav-item">
          <a href="/admin/settings_integrations.php" class="nav-link <?php echo (in_array(basename($_SERVER['PHP_SELF']), ['settings_integrations.php', 'settings_rmm.php']) ? 'active' : ''); ?>">
