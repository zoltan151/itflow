...
if (isset($_POST['edit_ticket_settings'])) {
    ...
    $config_ticket_attention_notification_email = sanitizeInput($_POST['config_ticket_attention_notification_email'] ?? '');
